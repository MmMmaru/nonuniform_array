function ln = calculate_ABE_features(element_index, all_coords, K, M, Rc, lambda, large_element_coords)
    % 统一单位mm
    ...
    for m = 1:M
        ...
        if ~isempty(in_section_indices)
            ...
            r_relative_inv(start_idx_in_vec : end_idx_in_vec) = sorted_r(1:num_to_take);
            % 其他默认为 0 (对应 1/inf)
        end
    end
    ...
    ln = [r_relative_inv; r_large]; % 列向量形式
end
